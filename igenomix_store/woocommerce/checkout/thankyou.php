...
<div class="woocommerce-order checkoutthankyou">
	...
	?>
		...
		<?php else : ?>
			...
			<h2 class="checkoutthankyou__title woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', esc_html__('Thank you. Your order has been received.', 'woocommerce'), $order); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
																		?></h2>

			<ul class="checkoutthankyou__list woocommerce-order-overview woocommerce-thankyou-order-details order_details">
